            ...
            <div className="row">
                        <div className="col-md-9">
                            <div className="mb-3">
                                ...
                                <input type="text" name="brand_Id" value={brand_Id} onChange={(e)=>setBrand_Id(e.target.value)} className="form-control" required></input>
                            </div>
                            <div className="mb-3">
                                <label htmlFor="">Tên danh mục</label>
                                <input type="text" name="category_Id" value={category_Id} onChange={(e)=>setCategory_Id(e.target.value)} className="form-control" required></input>
                            </div>
                            <div className="mb-3">
